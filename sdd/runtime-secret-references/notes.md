...
`bash -n`, `git diff --check`, YAML parsing, and a focused Bash regression harness passed. The containerized Bats suite and ShellCheck could not run locally because Docker was unavailable and the binaries were not installed.
